(() => {
  ...
  const a = function (e, n, a) {
    ...
    d = document.querySelector("[data-listContainer]"),
    i = document.querySelector("[data-addListBtn]");
  function l(t = "list title") {
    const e = c.content.cloneNode(!0),
      n = e.querySelector("[data-title]");
    n.value = t;
    const o = e.querySelector("[data-taskList]");
    return (
      e.querySelector("[data-input]").addEventListener("keydown", function (t) {
        "Enter" == t.key &&
          (u(o, { text: this.value, id: a() }), (this.value = ""), p());
      }),
      n.addEventListener("input", (t) => {
        y(n), p();
      }),
      o.addEventListener("contextmenu", (t) => {
        t.preventDefault(), t.target.matches(".task") && t.target.remove(), p();
      }),
      (o.ondrop = m),
      (o.ondragover = f),
      (o.ondragleave = g),
  ...
  function p() {
    ...
    console.log(t), localStorage.setItem("TASKS_APP_INFO", JSON.stringify(t));
  }
  function f(t) {
  ...
  !(function () {
    ...
    console.log(t),
      t &&
        t.forEach((t) => {
          const e = l(t.listTitle);
          t.tasks.forEach((t) => {
            u(e, t);
          });
        });
  })(),
    "" === d.innerHTML && l("Awesome List"),
